            ...
            <div className="flex mb-4 text-sm">
              <div className="flex gap-5">
                <div className="flex items-center gap-1">
                  <span className="text-xs uppercase text-amber-200/80">wins</span>
                ...
                <div className="flex items-center gap-1">
                  <span className="text-xs uppercase text-amber-200/80">losses</span>
      ...
      {show && (
        <div className="max-w-6xl mx-auto grid grid-cols-3 gap-6 mt-10">
          {matches.map((match, index) => (
            ...
            >
              <p><b className="font-bold text-amber-300">Match ID:</b> {match.match_id}</p>
              <p><b className="font-bold text-amber-300">League:</b> {match.league_name}</p>
              <p><b className="font-bold text-amber-300">Radiant Score:</b> {match.radiant_score}</p>
              <p><b className="font-bold text-amber-300">Dire Score:</b> {match.dire_score}</p>
              <p><b className="font-bold text-amber-300">Opponent Team:</b> {match.opposing_team_id}</p>
              <p><b className="font-bold text-amber-300">Start Time:</b> {match.start_time}</p>
            </div>
          ))}
        </div>
      )}
